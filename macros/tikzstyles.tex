...
\definecolor{notsodarkyellow}{rgb}{0.7,0.7,0}
...
\tikzstyle{reac}=[node distance=1.5cm, ->, every node/.style={circle,draw=black,minimum
                size=15pt,text=black}, >=latex]
\tikzstyle{ko}=[fill=red!50]
\tikzstyle{kobis}=[ko, fill=yellow!50]



\tikzstyle{active}=[fill=yellow!70, thick]
\tikzstyle{inactive}=[ko, thick]
\tikzstyle{badgene}=[active, draw=notsodarkred, -, decorate,decoration={zigzag,segment length=1pt,amplitude=.5pt}]
\tikzstyle{inactivebadgene}=[badgene, inactive]
