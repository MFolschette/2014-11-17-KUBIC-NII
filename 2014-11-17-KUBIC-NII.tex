...
\date{\thedate}
\conference{KUBIC-NII Seminar}{KUBIC-NII Joint Seminar on Bioinformatics 2014}
...
\newcommand{\citejiang}{Jiang, Tamura, Ching, Akutsu in \textit{Communications and Computer Sciences}, 2013}
\newcommand{\citeffl}{Comet, Bernot in \textit{Nice Spring school on Modelling and simulation of biological processes in the context of genomics}, 2010}
\newcommand{\citecutsets}{Paulevé, Andrieux, Koeppl in \textit{Computer Aided Verification}, 2013.}
...
\input{parts/def_impactdegree.tex}
...
\input{parts/cutsets}
\input{parts/ex_impactdegree}
\input{parts/altpaths}
...
\input{parts/annex_cooperations.tex}
